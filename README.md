...
الفيديو الناتج عمودي 1080×1920. ربط Facebook وYouTube يحتاج OAuth/Graph API رسمي، ولا تحفظ الأسرار داخل GitHub.

**ملاحظة:** الـAPK الحالي هو واجهة Android للمحرك، وليس محرك Python مضمناً داخل APK. محرك الفيديو يحتاج تشغيل Python/Termux أو خادم خارجي.
