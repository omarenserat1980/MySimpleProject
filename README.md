...
هذا الـAPK هو واجهة Android للمشروع، أما محرك إنشاء الفيديو Python/MoviePy فهو خادم منفصل. لتوليد الفيديو محلياً على الهاتف، شغّل `run_mobile.py` في Python/Termux على الهاتف ثم افتح التطبيق واترك العنوان `http://127.0.0.1:8080/`.
